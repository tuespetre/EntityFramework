...
namespace Microsoft.EntityFrameworkCore.Query.Expressions
{
    ...
    public class SelectExpression : TableExpressionBase
    {
        ...
        public virtual bool HandlesQuerySource([NotNull] IQuerySource querySource)
        {
            ...
            if (QuerySourceMatches(this, querySource))
            {
                return true;
            }
            ...
            {
                if (QuerySourceMatches(table, querySource))
                {
                    return true;
                }
                ...
                if (join != null && QuerySourceMatches(join.TableExpression, querySource))
                {
                    return true;
                }
            ...
            bool QuerySourceMatches(TableExpressionBase target, IQuerySource candidate)
            {
                return target.QuerySource == candidate
                    || (target.QuerySource is GroupJoinClause groupJoinClause
                        && groupJoinClause.JoinClause == candidate);
            }
        }
        ...
        public virtual void ExplodeStarProjection()
        {
            ...
            {
                var subquery = _tables.Single() as SelectExpression;
